...
if ($branchNameSegment -ieq "feature") {
    ...
    $docfx_param = "$topLevelPath/src/Projects/Coree.NET/Docfx/build/docfx_local.json"
...
if ($null -ne $docfx_param)
{
    Copy-Directory -sourceDir "$topLevelPath/src/Projects/Coree.NET/Docfx/result/local/" -destinationDir "$topLevelPath/docs/docfx" -exclusions @('.git', '.github')
}
